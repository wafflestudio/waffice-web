...
export function MemberDetailDialog({
	...
	return (
		<>
			<Dialog open={open} onOpenChange={onOpenChange}>
				<DialogContent
					className="!block !w-[1500px] !max-w-none max-h-[calc(100vh-40px)] overflow-hidden rounded-[15px] border-0 bg-white p-0 shadow-[0_4px_16px_rgba(0,0,0,0.12)]"
					showCloseButton={false}
				>
					<div className="flex h-[min(1130px,calc(100vh-40px))] flex-col bg-white">
