...
**Waffice-Web**은 와플 스튜디오의 내부 운영을 효율적으로 관리하기 위한 관리자 대시보드 웹 애플리케이션입니다. Next.js 15 기반으로 구축되었으며, 멤버 관리, 프로젝트 추적, 지출 청구, 회계 관리 등의 기능을 제공합니다.

## 주요 기능

### 대시보드 (/)
- 전체 통계 한눈에 보기 (멤버 수, 활성 프로젝트, 대기 중인 지출 청구, 계정 잔액)
- 최근 활동 피드
- 빠른 작업 바로가기
...
### 지출 청구 (/expense-claims)
- 지출 청구서 제출
- 프로젝트별 지출 기록
- 영수증 URL 첨부
- 관리자 승인/거부 워크플로우
- 검토 노트 추가
- 청구 상태 추적 (대기 중, 승인됨, 거부됨)

### 회계 관리 (/accounting)
- 재무 요약 대시보드 (총 수입, 총 지출, 잔액, 거래 수)
- 수입/지출 거래 기록
- 거래 코멘트 추가
- 거래 수정 및 삭제
- 자동 잔액 계산
...
│   │   ├── accounting/          # 회계 관리 페이지
│   │   └── expense-claims/      # 지출 청구 페이지
│   │
│   ├── components/
